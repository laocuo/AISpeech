package com.baidu.speech.tts.control;
...
import com.baidu.speech.tts.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    public void changeVoice(String voiceType){
        mSpeechSynthesizer.setParam(SpeechSynthesizer.PARAM_SPEAKER, voiceType);
    }
}
